...
export function EditDialog() {
    ...
    const onSubmit = async (data) => {
        ...
        await axios.post("http://localhost:4000/api/v1/users/update-profile", { fullname, description, website, Branch, Batch }, { withCredentials: true })
            .then((res) => {
        ...
        if (data.profileImage.length !== 0) {
            ...
            await axios.patch("http://localhost:4000/api/v1/users/avatar",fd , { withCredentials: true })
                .then((res) => {
                    console.log(res.data);
                    dispatch(login(res.data.data))
                }).catch((err) => {
        ...
        if (data.bannerImage.length !== 0) {
            ...
            await axios.patch("http://localhost:4000/api/v1/users/coverImage", fd, { withCredentials: true })
