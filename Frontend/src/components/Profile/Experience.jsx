...
export function EditExperince({ children, expId }) {
    ...
    const onSubmit = async (data) => {
        ...
        if (!expId) {
            ...
            await axios.post(`${import.meta.env.VITE_SERVER_URI}/users/Add-Exprience`, data, { withCredentials: true })
                .then(async (res) => {
        ...
        await axios.patch(`${import.meta.env.VITE_SERVER_URI}/users/update-Exprience`, { ...data, expId })
            .then((res) => {
                dispatch(login(res.data))
            })
            .catch((error) => {
