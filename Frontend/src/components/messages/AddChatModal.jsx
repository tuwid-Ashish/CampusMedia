...
const AddChatModal = ({ open, onClose, onSuccess }) => {
  ...
  const getUsers = async () => {
    ...
    requestHandler(
      ...
      async () => await getAvailableUsers(), // No loading setter callback provided
  ...
  const createNewChat = async () => {
    ...
    await requestHandler(
      ...
      async () => await createUserChat(selectedUserId), // Callback to handle loading state
      setCreatingChat, // Success callback
      res => {
        const { data } = res // Extract data from response
  ...
  const createNewGroupChat = async () => {
    ...
    await requestHandler(
      ...
      async () =>
        ...
        }), // Callback to handle loading state
      setCreatingChat, // Success callback
      res => {
        const { data } = res // Extract data from response
        onSuccess(data) // Execute the onSuccess function with received data
